  ...
  _getCurrentLocation() async {
    Geolocator.getCurrentPosition(desiredAccuracy: LocationAccuracy.best)
      ...
      http.Response response = await http.get(
          "http://api.openweathermap.org/data/2.5/weather?lat=${lat}&lon=${long}&units=metric&appid=e69551cdd83c7adfa7e56c37e586c1c5");
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      resizeToAvoidBottomInset: false, // set it to fals
        appBar: AppBar(
        title: Text("181011450441 - Zafar Maulana Sidiq"),
        ),
      body: Container(
